    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up the fundamental information for your campaign. You can always come back and edit these details later.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(handleNext)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Provide context about the goals, target audience, or key messages for this campaign.
              </p>
            </div>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          <p>• Use specific, descriptive names that include the content type (video, image, script)</p>
          ...
          <p>• Consider including the brand or product name for easy identification</p>
        </CardContent>
      </Card>
    </div>
  );
